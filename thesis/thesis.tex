...
% ---------- Float placement ----------
% Default fractions are restrictive (textfraction 0.2, topfraction 0.7), which
% forces tall figures in float-heavy sections to leave large gaps. Relax them so
% LaTeX packs floats and text into the same column and fills it.
...
% ---------- Official LIACS title page metadata ----------
\input{titlepage}
\title{Beyond Scalar Fitness:\\ Behavioural Feedback for LLM-Driven\\ Metaheuristic Evolution}
\author{Max Harell}
\studentnumber{s3815129}
\date{\today}
\supervisor{Dr.\ Niki van Stein}
\secondsupervisor{Dr.\ Thomas B\"{a}ck}
...
% ---------- Official LIACS title page ----------
\maketitle

% ---------- Abstract (numbered as Section 0) ----------
\setcounter{page}{1}
