...
\begin{quote}
\textit{Does incorporating trajectory-based behavioural features into the evolutionary feedback loop of LLM-driven optimisation algorithm design improve the performance and generalisation of discovered metaheuristics compared to fitness-only feedback, and does the framing of that feedback (neutral, directional, or comparative) affect the outcome?}
\end{quote}
