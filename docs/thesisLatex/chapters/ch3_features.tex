...
This chapter defines the behavioural feature vocabulary used throughout the thesis. \Cref{sec:features:principles} states the criteria that guided feature design and selection. The remaining sections present the 32 resulting features, organised by origin: inherited metrics, step-size and movement dynamics, information-theoretic measures, adapted population dynamics, and features new to the optimisation literature.
...
\texttt{tsfresh}~\cite{christ2018tsfresh}, and de~Nobel et
